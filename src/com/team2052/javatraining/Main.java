            ...
            while(!isDead && !hasWon){
                switch (currentPosition) {
                    case 0:
                        ...
                        if (inputValue.toLowerCase().trim().equals("n")) {
                            currentPosition = 1;
                             ...
                             break;
                    case 1:
                        System.out.println("You are standing at a hallway intersection that moves in all four directions; north, south, east and west, choose your path");
                        inputValue = input.nextLine();
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        System.out.println("A dark archway stands before you. Do you enter \"E\" or Go Back \"B\"");
                        inputValue = input.nextLine();
                        if (inputValue.toLowerCase().trim().equals("e")) {
                            System.out.println("You slowly walk through and find a massive ogre sleeping");
                            System.out.println("Do you fight \"E\" or Go Back \"B\"");
                            inputValue = input.nextLine();
                        }
                        if ((inputValue.toLowerCase().trim().equals("e")) && (hasSword)){
                             System.out.println("After a long fight, you defeat the ogre and teleport out of the dungeon. Congrats, you have won!");
                             hasWon = true;
                        }
                                else if ((inputValue.toLowerCase().trim().equals("e")) && (!hasSword)){
                                System.out.println("You lost the fight horribly without a weapon, game over.");
                                isDead = true;
                                }
                                else if (inputValue.toLowerCase().trim().equals("b")) {
                                currentPosition = 1;
                        ...
                        break;
                    case 4:
                        System.out.println("You have found a gleaming sword! Continue on with your dungoneering");
                        hasSword = true;
                        currentPosition = 1;
                        break;
