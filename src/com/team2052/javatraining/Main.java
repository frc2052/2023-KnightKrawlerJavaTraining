...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String inputValue;
   // need to keep fixing case and position
       // Variable to store the users name once they provide it
        String name;
       ...
       boolean beenBurnt = false;
       boolean hasFlyingShoes = false;
       // ASSIGNMENT B:
           ...
           switch (currentPosition) {
               ...
               case 2:
                   ...
                   if (inputValue.toLowerCase().trim().equals("e")) {
                       ...
                       currentPosition = 1;
                       System.out.println("you go back to the four hallways.");
                   } else {
               ...
               case 3:
                   ...
                   inputValue = input.nextLine();
                    if (inputValue.toLowerCase().trim().equals("e")) {
                        currentPosition = 5;
                        System.out.println("You push the door open, and find a mostly empty room, with a sword leaning against the wall in the far corner. The sword seems to give off it's own light.");
                   ...
                   case 4: 
                       ...
                       inputValue = input.nextLine();
                       if (inputValue.toLowerCase().trim().equals("Y")) {
                           System.out.println("You open the door and find a stone table, with a single bottle filled with a pale blue liquid. The bottle has a stopper in the shape of a sword. Do you drink the liquid in the bottle? Y or N");
                           inputValue = input.nextLine();
                           if (inputValue.toLowerCase().trim().equals("Y")) {
                               System.out.println("Drinking the potion, there are no noticable effects, and you return to the four hallways.");
                               hasPotion = true;
                               currentPosition = 1;
                       }
                            if (inputValue.toLowerCase().trim().equals("N")) {
                                System.out.println("Unwilling to take the risk, you return to the four hallways");
                                currentPosition = 1;
                            }
                   }
                        //finishing reproggramming potion room
                   break;

                   case 5:
                       System.out.println("you follow the hall to the west. it appears to be a dead end, except for a small alcove in the left wall, which has a pair of winged shoes tucked into it. you put them on, and return to the four hallways");
                       hasFlyingShoes = true;
                       currentPosition = 1;
                   break;
                }
